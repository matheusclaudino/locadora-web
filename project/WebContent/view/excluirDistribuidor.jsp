...
<%@ include file="import/navbar.jsp"%>
	...
	<div class="jumbotrom">
		<div class="container">
			...
			<h1><span class="fa fa fa-truck"></span> Excluir Distribuidor</h1>
					...
					<div class="row">
						...
						<fieldset class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="razao" name="razao" value="${param.razao}" autofocus  readonly="readonly">	
							</div>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="cnpj" name="cnpj"  value="${param.cnpj}"
										placeholder="00.000.000/0000-00"  readonly="readonly">
								</div>
							</div>
