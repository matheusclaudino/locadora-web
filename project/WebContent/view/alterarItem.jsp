...
%>
	...
	<div class="jumbotrom">
		<div class="container">
			...
			<h1><span class="fa fa-video-camera"></span> Alterar Item</h1>
					...
					<div class="row">
						<fieldset class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="numero" name="numero" value="${param.numero}" autofocus>	
							</div>
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" id="data" name="data" value="${param.data}"placeholder="dd/mm/aaaa">
							</div>
