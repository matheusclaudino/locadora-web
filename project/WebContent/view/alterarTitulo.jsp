...
%>
	...
	<div class="jumbotrom">
		<div class="container">
			...
			<h1><span class="fa fa-film"></span> Alterar Título</h1>
					...
					<div class="row">
						...
						<fieldset class="col-sm-6 col-md-6">	
								<div class="form-group">
									...
									<input type="text" class="form-control" id="nome" name="nome" autofocus value="<%out.print(titulo.getNome());%>">	
								</div>
								
								<div class="form-group">
									<label for="sinopse">Sinopse</label>
									<textarea class="form-control" id="sinopse" name="sinopse" rows="5" placeholder="Escreva a sinopse" value="<%out.print(titulo.getSinopse());%>"></textarea>
								</div>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="ano" name="ano" placeholder="aaaa" value="<%out.print(titulo.getAno());%>">
								</div>
						</fieldset>	<!--fim fieldset-->
						<fieldset class="col-sm-6 col-md-6">
